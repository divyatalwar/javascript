...
function limitCheck(val) {
    ...
    if (val.checked === true) {
        //this loop adds the elements to the array if it is checked.only after checking the value of count.       
        if (count >= 3) {
            val.checked = false;
        ...
        //if the user after checking the checkbox unchecks it.the element added to the array is removed and count is decremented.
